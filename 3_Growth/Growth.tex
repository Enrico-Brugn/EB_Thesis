...
\begin{figure}
    ...
    \caption[Growth recipe and \acs{sem_m} image of sample 1.]{Growth of the first sample. \subref{subfig:recipe1} Is the diagram representing the growth recipe for a simple single-heterointerface III-V wire \cite{Brugnolotto2023}. Each line represents an active flow of precursor into the reactor. The colour of the horizontal lines represents the target material. \subref{subfig:comb_sample1} shows a \acs{sem_m} image of an \num{11}-nanowire array. The \acs{si} seed, III-V segment, empty template, and template opening are visible from left to right.}
...
\begin{figure}
    ...
    \subcaptionbox{
        ...
        \tikzsetnextfilename{s1_III_EDS}
        \begin{tikzpicture}
            \node[inner sep=0pt] (image) at (0,0) {\includegraphics[width=0.45\textwidth]{3_Growth/s1_III_EDS.pdf}};
        \end{tikzpicture}
    }
    \subcaptionbox{
        ...
        \tikzsetnextfilename{s1_V_EDS}
        \begin{tikzpicture}
            \node[inner sep=0pt] (image) at (0,0) {\includegraphics[width=0.45\textwidth]{3_Growth/s1_V_EDS.pdf}};
        \end{tikzpicture}
    }
    \subcaptionbox{
...
\begin{figure}
    ...
    \subcaptionbox{
        ...
        \tikzsetnextfilename{s2_III_ov_EDS}
        \begin{tikzpicture}
            \node[inner sep=0pt] (image) at (0,0) {\includegraphics[width=0.45\textwidth]{3_Growth/s2_III_ov_EDS.pdf}};
        \end{tikzpicture}
    }
    \subcaptionbox{
        ...
        \tikzsetnextfilename{s2_V_ov_EDS}
        \begin{tikzpicture}
            \node[inner sep=0pt] (image) at (0,0) {\includegraphics[width=0.45\textwidth]{3_Growth/s2_V_ov_EDS.pdf}};
        \end{tikzpicture}
    }
    \caption[\acs{bf}-\acs{stem} overview image of a nanowire cross section with \acs{eds} maps.]{Microscopy images of the second sample. \subref{subfig:s2_r_ov} shows a \acs{bf}-\acs{stem_m} image of the lamella of sample 2, centred on the right wire. Various interfaces are visible, such as the \acs{si}/III-V interface and those between the two materials in the thick \acs{inp} and \acs{ingaas} layers. Some other areas of interest are also present. \subref{s2_III_ov_EDS} shows the III-element \acs{eds} map, and \subref{s2_V_ov_EDS} the V-element \acs{eds} map, of the lamella shown in \subref{subfig:s2_r_ov}.}
...
\begin{figure}
    ...
    \subcaptionbox{
        ...
        \tikzsetnextfilename{s2_int2_P}
        \begin{tikzpicture}
            \node[inner sep=0pt] (image) at (0,0) {\includegraphics[width=0.45\textwidth]{3_Growth/s2_int2_P.pdf}};
        \end{tikzpicture}
    }
    \subcaptionbox{
...
\begin{sidewaysfigure}
    ...
    \label{fig:issues}
        ...
        \tikzsetnextfilename{issues}
    \begin{tikzpicture}
        \node[inner sep=0pt] (image) at (0,0) {\includegraphics[width=0.45\textwidth]{3_Growth/issues.pdf}};
    \end{tikzpicture}
    }
    \subcaptionbox{
...
\begin{figure}
    ...
    \tikzsetnextfilename{s3_III_map}
    \begin{tikzpicture}
        \node[inner sep=0pt] (image) at (0,0) {\includegraphics[width=0.45\textwidth]{3_Growth/s3_III_map.pdf}};
    \end{tikzpicture}
    }
    \subcaptionbox{
    ...
    \tikzsetnextfilename{s3_V_map}
    \begin{tikzpicture}
        \node[inner sep=0pt] (image) at (0,0) {\includegraphics[width=0.45\textwidth]{3_Growth/s3_V_map.pdf}};
    \end{tikzpicture}
    }
    \subcaptionbox{
    \acs{eds} map: Red-\acs{in} Blue-\acs{ga} \cite{Brugnolotto2023}
    ...
    \tikzsetnextfilename{s3_III_map_wells}
    \begin{tikzpicture}
        \node[inner sep=0pt] (image) at (0,0) {\includegraphics[width=0.45\textwidth]{3_Growth/s3_III_map_wells.pdf}};
    \end{tikzpicture}
    }
    \subcaptionbox{
    \acs{eds} map: Red-\acs{as} Blue-\acs{p} \cite{Brugnolotto2023}
    ...
    \tikzsetnextfilename{s3_V_map_wells}
    \begin{tikzpicture}
        \node[inner sep=0pt] (image) at (0,0) {\includegraphics[width=0.45\textwidth]{3_Growth/s3_V_map_wells.pdf}};
    \end{tikzpicture}
    }
...
\begin{figure}
    ...
    \caption{\acs{eds} linescans for the \subref{subfig:s3_III_linesc} III elements and \subref{subfig:s3_V_linesc} V elements across a \acl{qw}. The origin of the x-axis is situated before the well itself on the side of the \acs{si} seed, and higher position numbers (in nm) represent the scan moving along the \hkl{1 1 1} vector perpendicular to the growth front away from the seed.}
