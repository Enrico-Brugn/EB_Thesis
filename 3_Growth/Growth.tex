...
\begin{figure}
    ...
    \caption{\acs{eds} linescans for the \subref{subfig:s3_III_linesc} III elements and \subref{subfig:s3_V_linesc} V elements across a quantum well. The origin of the x-axis is situated before the well itself on the side of the \acs{si} seed, and higher position numbers (in nm) represent the scan moving along the \hkl{1 1 1} vector perpendicular to the growth front away from the seed.}
