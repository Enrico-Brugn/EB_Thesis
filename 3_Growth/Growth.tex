...
\begin{figure}
    ...
    \end{tikzpicture}
    \caption[High-resolution \acs{bf}-\acs{stem_m} image of the second \acl{qw} region of sample 3.]{High-resolution \acs{bf}-\acs{stem_m} image of the second \acl{qw} region of sample 3. The highlighted \acs{eds} linescan path shows the area sampled to create the composition profiles shown in Figure~\ref{fig:s3_linescans}.}
    \label{fig:s3_QW_HR}
\end{figure}
