...
\documentclass[11pt,titlepage,twoside,openright]{book} %
...
\usetikzlibrary{external, calc, shapes, positioning, plotmarks, datavisualization, decorations.pathmorphing, decorations.pathreplacing, decorations.text, 3d, arrows.meta} 
\tikzexternalize[prefix=figures_plex/] 
% colour
...
\newacronym{rtp}{RTP}{rotational twin plane}
\newacronym{apb}{APB}{anti-phase boundary}
\newacronym{qw}{QW}{quan\-tum well}
\newacronym{dft}{DFT}{density functional theory}
\newacronym[type = technique]{lart}{LART}{lateral aspect ratio trapping}
...
\newacronym[type = technique]{sls}{SLS}{strained-layer superlattice}
\newacronym[type = technique]{dfl}{DFL}{defect filter layer}
\newacronym[type = technique]{ima}{IMA}{interface misfit array}
\newacronym[type = technique]{vls}{VLS}{vapour-liquid-solid}
...
\newacronym[type = technique]{icp}{ICP}{in\-duc\-ti\-ve\-ly-coupled plasma}
...
\newacronym[type = technique]{df}{DF}{dark field}
...
\newacronym[type = technique]{gpa}{GPA}{geometric phase analysis}
\newacronym[type = technique]{snom}{SNOM}{scanning near-field optical microscopy}
\newacronym[type = technique]{ters}{TERS}{tip-enhanced Raman spectroscopy}
...
\newacronym[type = material]{gasb}{\ce{GaSb}}{gallium antimonide}
\newacronym[type = material]{tmin}{TMIn}{trimethyl indium}
\newacronym[type = material]{tmga}{TMGa}{trimethyl gallium}
\newacronym[type = material]{tmsb}{TMSb}{trimethyl antimony}
\newacronym[type = material]{tesn}{TESn}{tetraethyl tin}
\newacronym[type = material]{tbas}{TBAs}{\textit{tert}-butyl arsine}
\newacronym[type = material]{tbp}{TBP}{\textit{tert}-butyl phosphine}
\newacronym[type = material]{sio2}{\ce{SiO2}}{silicon oxide}
\newacronym[type = material]{hf}{\ce{HF}}{hydrofluoric acid}
\newacronym[type = material]{hbr}{\ce{HBr}}{hydrobromic acid}
\newacronym[type = material]{hsq}{HSQ}{hydrogen silsesquioxane}
\newacronym[type = material]{tmah}{TMAH}{tetramethylammonium hydroxide}
\newacronym[type = material]{h2so4}{\ce{H2SO4}}{sulfuric acid}
\newacronym[type = material]{h2o2}{\ce{H2O2}}{peroxide}
\newacronym[type = material]{h2o}{\ce{H2O}}{water}
...
\newacronym[type = material]{sb}{\ce{Sb}}{antimony}
\newacronym[type = material]{sn}{\ce{Sn}}{tin}
\newacronym[type = material]{ge}{\ce{Ge}}{germanium}
\newacronym[type = material]{pt}{\ce{Pt}}{platinum}
\newacronym[type = material]{o}{\ce{O}}{oxygen}
...
\include{0_Abstract/publications.tex}
\include{0_Abstract/contributions.tex}
...
\include{4_Properties/Properties}
\include{5_Yield_Analysis/Yield_Analysis}
