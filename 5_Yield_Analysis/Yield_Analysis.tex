...
\begin{table}
    ...
    \begin{tabular}{l|ccccccc}
        ...
        \hline \hline
        Perpendicular & \num{208} & \num{315} & \num{7} & \num{4} & \num{5} & \num{5} & \num{20} \\ 
        \textit{\% of category} & \textit{\qty{56.5}{\%}} & \textit{\qty{66.7}{\%}} & \textit{\qty{41.2}{\%}} & \textit{\qty{50}{\percent}} & \textit{\qty{62.5}{\%}} & \textit{\qty{2.4}{\%}} & \textit{\qty{24.7}{\%}} \\ 
        \hline
        \qty{30}{\degree} misaligned & \num{160} & \num{162} & \num{10} & \num{4} & \num{3} & \num{206} & \num{61} \\ 
        \textit{\% of category} & \textit{\qty{43.5}{\%}} & \textit{\qty{33.3}{\%}} & \textit{\qty{58.8}{\%}} & \textit{\qty{50}{\%}} & \textit{\qty{37.5}{\%}} & \textit{\qty{97.6}{\%}} & \textit{\qty{75.3}{\%}} \\ 
        \hline
        \textbf{Total} & \textbf{\num{368}} & \textbf{\num{487}} & \textbf{\num{17}} & \textbf{\num{8}} & \textbf{\num{8}} & \textbf{\num{211}} & \textbf{\num{81}} \\
        \hline
    \end{tabular}
