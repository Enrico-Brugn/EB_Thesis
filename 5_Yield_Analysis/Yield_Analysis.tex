...
\begin{figure}
    ...
    \subcaptionbox{
        ...
        \tikzsetnextfilename{mask_array}
        \begin{tikzpicture}
            \node[inner sep=0pt] (image) at (0,0) {\includegraphics[width = 0.475\textwidth]{5_Yield_Analysis/Fig/mask_array.pdf}};

            \node [rotate=35] (si) at (2, -2) {\acs{si} nanostructure};
            \draw [-stealth] (si) -- (-0.2, -1.4);
            \node [rotate=35] (open) at (-2, 2) {Template openings};
            \draw [-stealth] (open) -- (-2, -0);
            \draw [-stealth] (open) -- (-0.35, 1.2);
            \draw [-stealth] (open) -- (1.3, 2.2);
        \end{tikzpicture}
    }
    \subcaptionbox{
        ...
        \tikzsetnextfilename{mask_section}
        \begin{tikzpicture}
            \node[inner sep=0pt] (image) at (0,0) {\includegraphics[width = 0.475\textwidth]{5_Yield_Analysis/Fig/mask_section.pdf}};

            \draw [red] (2.15, -1.7) rectangle (1.75, -1.3);
            \node [red] (a) at (1, -1.5) {(A)};
            \draw [red, -stealth] (a) -- (1.75, -1.5);
        \end{tikzpicture}
    }
    \subcaptionbox{
        ...
        \tikzsetnextfilename{mask_division}
        \begin{tikzpicture}
            \node[inner sep=0pt] (image) at (0,0) {\includegraphics[width = 0.475\textwidth]{5_Yield_Analysis/Fig/mask_division.pdf}};

            \draw [red] (-2.8, 2) rectangle (-1.3, 3.5);
            \node [red] (a) at (-3.3, 1) {(B)};
            \draw [red, -stealth] (a) -- (-2.5, 2);
        \end{tikzpicture}
    }
    \subcaptionbox{
        Mask of the chip.
...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \node at (11,-3.8) {(4)};
        \draw [red, -stealth] (2.4, -3.7) -- ++ (-3.5, 0) node [midway, anchor=north] {Growth direction};
        \draw [red, -stealth] (10.4, -3.7) -- ++ (-3.5, 0) node [midway, anchor=north] {Growth direction};
        \draw [red, -stealth] (2.4, -0.7) -- ++ (-3.5, 0) node [midway, anchor=north] {Growth direction};
        \draw [red, -stealth] (10.4, -0.7) -- ++ (-3.5, 0) node [midway, anchor=north] {Growth direction};
    \end{tikzpicture}
    \caption[Four \acs{bf}-\acs{stem_m} images of different nanowires from the lamella cut for sample 7.]{Four \acs{bf}-\acs{stem_m} images of different nanowires from the lamella cut for sample 7. They all share similar growth rates and internal structures.}
    \label{fig:s7_OVs}
\end{figure}
...
\begin{figure}
    ...
    \subcaptionbox{
        ...
        \begin{tikzpicture}
            \node[inner sep=0pt] (image) at (0, 0) {\includegraphics[width = 0.72\textwidth]{5_Yield_Analysis/Fig/wire_array.pdf}};
    ...
    \subcaptionbox{
        ...
        \begin{tikzpicture}
            \node[inner sep=0pt] (image) at (0, 0) {\includegraphics[width = 0.20\textwidth]{5_Yield_Analysis/Fig/single_column_2.pdf}};
...
\begin{figure}
    \centering
    \subcaptionbox{
        F\(_1\) score and loss for each training epoch \cite{Brugnolotto2024}.
    ...
    \caption[Training metrics for the classifier.]{Training metrics for the classifier \cite{Brugnolotto2024}. \subref{subfig:F1Score} shows the evolution of the F\(_1\) score and the loss during training. \subref{subfig:confusion_matrix} shows the confusion matrix of the trained classifier calculated on the test fraction. This Figure was adapted from the work of Brugnolotto \textit{et al.} \cite{Brugnolotto2024} under the terms of the CC BY 4.0 licence \cite{CCBY40}.}
