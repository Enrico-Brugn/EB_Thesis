...
\begin{figure}
    ...
    \subcaptionbox{
        ...
        \includegraphics[width=\textwidth]{5_Yield_Analysis/Fig/defects_parasitic.pdf}
    }
    \subcaptionbox{
    ...
    \caption[Arrays from sample 7 presenting different types of defects.]{Arrays from sample 7 presenting different types of defects. \subref{subfig:defects_parasitic} shows a parasitic crystal hiding numerous nucleation sites from view. \subref{subfig:defects_unucleated} shows several nucleation sites where nucleation has not occurred. Two sites also contain defective wires. \subref{subfig:defects_oxide_nucleated} shows a template with nucleation on both the \acs{si} seed, resulting in a small III-V particle, and on the template wall.}
    \label{fig:defects}
\end{figure}
