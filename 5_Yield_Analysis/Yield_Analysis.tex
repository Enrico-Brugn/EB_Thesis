...
The pooling method is based on two different kernels parsing the \texttt{numpy} array and overwriting its values to highlight vertical edges. These two kernels are called \texttt{min\_pool} and \texttt{max\_pool}. Aside from selecting either a minimum or maximum value, their implementation is identical. A 
