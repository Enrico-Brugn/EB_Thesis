...
\begin{figure}
    ...
    \caption[\acs{sem_m} images of nanowire arrays.]{Caption}
    \label{fig:s7_arrays}
\end{figure}

These specifications do not require a full \acs{stem_m} analysis. Instead, a \acf{sem_m} survey of the arrays in the sample is sufficient to assess the growth yield. One such survey, resulting in an open access dataset \cite{dataset}, was carried out on samples 6 and 7.
