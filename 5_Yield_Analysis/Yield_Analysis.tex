...
The main challenge is to produce images of isolated nanowires from an image such as that in Figure~\ref{fig:raw_image}. This particular image was captured with low contrast, other images, such as those seen in Figure~\ref{fig:class_examples} were captured under different acquisition settings, making defining a hardcoded intensity levels difficult to, for example, detect whether or not a wire is there and what shape it has.
