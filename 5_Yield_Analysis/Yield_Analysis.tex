...
Data on defective wires can also be divided between perpendicular and \qty{30}{\degree} misaligned growth sites, as shown in Table~\ref{tab:defects_overview_sites}. The total number of perpendicular growth sites surveyed is \num{9504}: higher than the number of \qty{30}{\degree} misaligned sites, which is \num{6336}. This is caused by three out of five sections containing perpendicular growth sites for both samples. As a result, the total amount of defects in the perpendicular sections is expected to be higher, if equal possibility of defective wire presence is expected. On the other hand, if the presence of a tilted seed surface is expected to be a disadvantage for the growth of perfect wires, this should be reflected in an equal, or higher, number of defective wires for the misaligned sites.

A first count of the total number of defective wires points to this conclusion, with \num{564} defective wires for the perpendicular growth sites and \num{616} for the \qty{30}{\degree} misaligned sections.
