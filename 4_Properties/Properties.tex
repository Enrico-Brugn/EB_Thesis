...
Two more binary materials, \acf{gaas} and \acf{inas}, can be grown without altering the precursor species introduced into the reactor from those used in previous experiments. 
...
\begin{table}
  \centering
  \caption{V/III ratios used in the MOCVD growth of sample 7 \cite{Brugnolotto2023_2}.}
  \label{tbl:s7_ratios}
