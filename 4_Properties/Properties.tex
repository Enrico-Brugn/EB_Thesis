...
Therefore, the three arsenide materials are better identified as \acs{inas}, \ce{In0_.75Ga0_.35As}, and \ce{In0_.55Ga0_.45As}. Longer hold steps could solve the alloying issue in these material layers.
...
\begin{figure}
    ...
    \caption{High-resolution \acs{bf}-\acs{stem_m} images of the first three quantum wells of the nanowire pictured in Figure~\ref{fig:s7_OV}. \subref{subfig:s7_well1} shows the first \acs{inas} \acl{qw}, \subref{subfig:s7_well1} shows the first \ce{In0_.75Ga0_.35As} \acl{qw}, and \subref{subfig:s7_well1} shows the first \ce{In0_.55Ga0_.45As} \acl{qw}.}
