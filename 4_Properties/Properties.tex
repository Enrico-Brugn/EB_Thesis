...
\begin{figure}
    ...
    \caption{\acs{eds} linescan compositional data (in percentage) for the \subref{subfig:s6_III_30deg_linesc} III elements and \subref{subfig:s6_V_30deg_linesc} V elements of sample 9 (Figure~\ref{subfig:s6_wire_OV}).}
    \label{fig:s6_30deg_linescans}
\end{figure}
