...
However, this finding does show that it is not only a pure phosphide layer that can stabilise a single \hkl{1 1 1} growth front within a \acs{tase} template, but also phosphide arsenides. This result shows that \acl{sn} has no negative effect on the growth and stabilisation of a single-facet growth front, making it a good dopant for device applications.
