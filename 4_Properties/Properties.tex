...
\begin{figure}
    ...
    \caption[Compositional data from \acs{eds} linescans across the first \acl{qw} of the nanowire cut from sample 9.]{\acs{eds} linescan compositional data (in atomic percentage) for the \subref{subfig:s6_III_30deg_linesc} III group elements and \subref{subfig:s6_V_30deg_linesc} V group elements of sample 9.}
