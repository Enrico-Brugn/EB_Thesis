...
The evolution of the growth front morphology during \acs{mocvd} growth is captured by the heterolayers embedded in the \acs{inp} matrix. All arsenide layers form parallel lines and are enclosed by \hkl{1 1 1} hetrointerfaces. Any eventual strain introduced in the nanowire lattice does not destabilise the \hkl{111}\(_B\) growth regimen.
