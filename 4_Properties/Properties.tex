...
Figure~\ref{subfig:merge_region} shows a magnified \acs{bf}-\acs{tem_m} image of the area immediately after the \acs{sio2} separation between the nucleation regions 2 and 3 marked in Figure~\ref{subfig:STEM_merge_structure_ov}. \acs{tem_m} images contain more structural information than their counterpart, highlighting 1D and 2D defects better than their \acs{stem_m}-generated counterparts.
