...
\begin{figure}
    ...
    \caption[\acs{sem_m} image of merge structures taken before and  during \acs{fib} lamella cut-out and thinning.]{\acs{sem_m} image of merge structures taken \subref{subfig:SEM_merge_bulk} before and \subref{subfig:SEM_merge_lamella} during \acs{fib} lamella cut-out and thinning.}
    \label{fig:SEM_merge}
\end{figure}
