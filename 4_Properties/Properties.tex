...
The experiments in this section were carried out to explore the possibility of the single-facet growth front regime being destabilised due to lattice mismatch-related stress in the \acl{qw} region. All samples presented so far in this thesis targeted an \ce{In0_.53Ga0_.47As} composition in the arsenide layers, with varying degrees of success, as shown in each sample's \acs{eds} analysis. This composition is lattice-matched to the supporting \acs{inp} barrier layer \cite{Pearsall1980, Sugii1983, Wagner1970}, therefore simplifying the growth process by confining any strain or stress to the initial material layers after nucleation.
