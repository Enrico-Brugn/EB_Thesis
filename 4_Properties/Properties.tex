...
\begin{sidewaysfigure}
    ...
    \caption[\acs{mocvd} precursor sequence and resulting nanowire for sample 6.]{\subref{subfig:recipe6} \acs{mocvd} precursor sequence and \subref{subfig:s6_wire_OV} resulting nanowire for sample 6.}
...
\begin{figure}
    ...
    \caption[High-resolution \acs{bf}-\acs{stem_m} images of sample 6.]{High-resolution \acs{bf}-\acs{stem_m} images of \subref{subfig:s6_si-IIIV_interface} the nucleation area, showing the \acs{si} / \acs{ingaas} hetyerointerface, and of \subref{subfig:s6_well1} the first \acl{qw} in sample 6.}
    \label{fig:s6_HR}
\end{figure}
