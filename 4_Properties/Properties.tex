...
\begin{sidewaysfigure}
    ...
    % lines
            ...
            \draw [cb1_dark_blue, ultra thick, dashed] (1, 0) -- (5, 0); %10
            \draw [cb1_orange, ultra thick] (7, 0) -- (7.5, 0);
            \draw [cb1_dark_blue, ultra thick, dashed] (9.2, 0) -- (10.2, 0); %10
        
            \node [label={[label distance=0]180:\acs{ga}}] at (0, -0.5) {};
            \draw [cb1_orange, ultra thick] (0, -0.5) -- (1, -0.5cm); 
            \draw [cb1_orange, ultra thick] (7, -0.5) -- (7.5, -0.5);
        
            \node [label={[label distance=0]180:\acs{as}}] at (0, -1) {};
            \draw [cb1_orange, ultra thick] (0, -1) -- (1, -1); 
            \draw [cb1_orange, ultra thick] (7, -1) -- (7.5, -1);
            \draw [gray, ultra thick] (7.5, -1) -- (8.2, -1);
        
            \node [label={[label distance=0]180:\acs{p}}] at (0, -1.5) {};
            \draw [cb1_dark_blue, ultra thick, dashed] (1, -1.5) -- (5, -1.5); %/10
            \draw [gray, ultra thick] (5, -1.5) -- (7, -1.5);
            \draw [gray, ultra thick] (8.2, -1.5) -- (9.2, -1.5);
            \draw [cb1_dark_blue, ultra thick, dashed] (9.2, -1.5) -- (10.2, -1.5); %/10
            \draw [gray, ultra thick] (10.2, -1.5) -- (12.2, -1.5);
    ...
    % labels and markers for the timescale
            ...
            \draw [dashed] (1, -2) -- (5, -2);
            \draw [] (5, -2) -- (9.2, -2);
            \draw [dashed] (9.2, -2) -- (10.2, -2);
            \draw [-stealth] (10.2, -2) -- (12.5, -2); % +0.3
            \draw [] (0, 0.2) -- (0, -2.2) node[anchor = north] {\num{0}};
            \draw [] (1, 1.2) -- (1, -2.2) node[anchor = north] {\num{10}};
            \draw [] (5, 0.2) -- (5, -2.2) node[anchor = north] {\num{410}};
            \draw [] (7, 0.4) -- (7, -2.2) node[anchor = north] {\num{430}};
            \draw [] (7.5, 0.2) -- (7.5, -2.8) node[anchor = north] {\num{435}};
            \draw [] (8.2, 0.2) -- (8.2, -2.2) node[anchor = north] {\num{442}};
            \draw [] (9.2, 0.2) -- (9.2, -2.2) node[anchor = north] {\num{452}};
            \draw [] (10.2, 0.2) -- (10.2, -2.2) node[anchor = north] {\num{552}};
            \draw [] (12.2, 1.2) -- (12.2, -2.2) node[anchor = north] {\num{572}};
            \draw [stealth - stealth] (7, 0.3) -- (12.2, 0.3) node[midway, anchor=south] {Quantum Well Loop (x\num{6})};
            \draw [stealth - stealth] (1, 1.1) -- (12.2, 1.1) node[midway, anchor=south] {Deposition Loop (x\num{2})};
        \end{scope}
        \begin{scope} [shift={(13.4cm, -0.5)}] % +0.9
            \draw [gray, ultra thick] (0, 0.5) -- (0.5, 0.5) node[anchor = west, text=black] {Hold Step};
            \draw [cb1_orange, ultra thick] (0, 0) -- (0.5, 0) node[anchor = west, text=black] {\acs{ingaas}};
            \draw [cb1_dark_blue, ultra thick] (0, -0.5) -- (0.5, -0.5) node[anchor = west, text = black] {\acs{inp}};
            \draw [dashed, ultra thick] (0, -1) -- (0.5, -1) node[anchor = west, text = black] {\num{0.1} time scale};
