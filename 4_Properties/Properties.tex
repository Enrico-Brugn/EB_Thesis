...
Growth rates for \acs{inp} layers range from \qty[separate-uncertainty=true]{20.8 (0.5)}{\nano\metre\per\minute} and \qty[separate-uncertainty=true]{20.8 (0.5)}{\nano\metre\per\minute}, and fall between those of samples 4 and 5. On the other hand, the growth rates of the \acs{ingaas} \acl{qw}s 
