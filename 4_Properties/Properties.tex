...
\begin{sidewaysfigure}
    ...
    \subcaptionbox{
        ...
        \begin{tikzpicture}
            ...
            \node [rotate=-50] at (1.9, -2.5) {Template};
            \node [rotate=-50] at (2.4, -2.4) {Opening};
            \node [white, rotate=-50] at (-3, 0) {\acs{si} backbone};
        \end{tikzpicture}
    }
    \subcaptionbox{
