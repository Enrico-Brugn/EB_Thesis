...
\begin{sidewaysfigure}
    ...
    % lines
            ...
            \draw [blue, ultra thick, dashed] (1, 0) -- (7, 0); %10
            \draw [red, ultra thick] (9, 0) -- (9.5, 0);
            \draw [blue, ultra thick, dashed] (11.2, 0) -- (12.2, 0); %10
        
            \node [label={[label distance=0]180:\acs{ga}}] at (0, -0.5) {};
            \draw [red, ultra thick] (0, -0.5) -- (1, -0.5cm); 
            \draw [red, ultra thick] (9, -0.5) -- (9.5, -0.5);
        
            \node [label={[label distance=0]180:\acs{as}}] at (0, -1) {};
            \draw [red, ultra thick] (0, -1) -- (1, -1); 
            \draw [red, ultra thick] (9, -1) -- (9.5, -1);
            \draw [ultra thick] (9.5, -1) -- (10.2, -1);
        
            \node [label={[label distance=0]180:\acs{p}}] at (0, -1.5) {};
            \draw [blue, ultra thick, dashed] (1, -1.5) -- (7, -1.5); %/10
            \draw [ultra thick] (7, -1.5) -- (9, -1.5);
            \draw [ultra thick] (10.2, -1.5) -- (11.2, -1.5);
            \draw [blue, ultra thick, dashed] (11.2, -1.5) -- (12.2, -1.5); %/10
            \draw [ultra thick] (12.2, -1.5) -- (14.2, -1.5);
...
The seed surface consists of a single \hkl{1 1 1} facet resulting from the selective etching of \acs{si} carried out with \acs{tmah} before deposition. This surface forms a \qty{90}{\degree} angle with the wafer plane, but, as can be seen in the highlight in Figure \ref{subfig:s6_wire_OV}, the first quantum well, and indeed all the others, are tilted \qty{3}{\degree} off the perpendicular. A slight rotation of the growing lattice compared to the seed's lattice orientation can occur during epitaxy, as it is a way for the growing crystal to compensate for some of the stress caused by lattice mismatch. Despite the \qty{3}{\degree} rotation the stabilisation of the \hkl{1 1 1} facet is achieved during the initial \acs{inp} deposition and maintained along the entirety of the wire.

\paragraph{High resolution analysis}
...
\begin{figure}
    ...
    \end{tikzpicture}
    \caption{\acs{ingaas} and \acs{inp} material layer growth rates as a function of their distance from the \acs{si} seed surface. Both x and y error bars are present but they are smaller than the markers, except for those on the growth rate of \acs{ingaas}.}
...
\begin{figure}
    ...
    The origin of the x-axis is situated before the first well and is the closest point to the \acs{si} seed. Higher position numbers (in nm) represent the scan moving along the \hkl{1 1 1} vector perpendicular to the growth front away from the seed.}
