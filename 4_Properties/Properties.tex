...
\begin{sidewaysfigure}
    ...
    \caption[III and V concentration profiles across the 7th, 8th, and 9th \acl{qw} of the nanowire cross section cut from sample 7.]{\subref{subfig:s7_III_EDS} III and \subref{subfig:s7_V_EDS} V concentration profiles across the 7th, 8th, and 9th \acl{qw} of the nanowire in Figure~\ref{fig:s7_OV} \cite{Brugnolotto2023_2}.}
    \label{fig:s7_EDS}
\end{sidewaysfigure}
