...
In this chapter, a variety of \acs{mocvd}-grown \acs{tase} structures with various layer thicknesses and semiconductor materials were explored. The \hkl{1 1 1} single growth front stabilisation growth regimen was confirmed to be an attractive methodology to control defects and material composition. Initially limited to a high V-III ratio \acs{inp}, it was shown that a high V-III ratio \ce{InAsP} can also provide the same \hkl{1 1 1} stabilisation effect. 
...
The greatest impact on growth rates was observed in samples grown in a competitive environment. The presence of many parasitic crystals deeply affected the growth of \acs{tase} nanowires, but also the growth regimen within the template. The alteration of the effective V / III ratio in this environment proved enough to cause the wire to lose its single-faceted growth front. This effect should be taken into account when attempting dense integration of \acs{tase} structure, especially if they differ in shape and size.

Photoluminescence analysis of the \acs{ingaas} \acs{qw}s showed dependence on their size and composition, as expected. Importantly, it was shown that the signal originating from \hkl{1 1 1} single-facet heterointerface quantum wells was sharper than that with a high influence of large multi-facet grown \acs{ingaas} segments.

The most important achievement shown in this chapter was the growth of a single crystal from multiple nucleation points, achieving crystalline quality comparable to that of single-nucleation nanowires. This was shown to be a reproducible process by Figure~\ref{fig:merge_ov} 
