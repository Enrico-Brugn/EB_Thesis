...
\begin{figure}
    ...
    \end{tikzpicture}
    \caption[Detail of the Fourier tranforms of sample 4 with inverse transforms.]{Detail of the Fourier tranforms of sample 4 seen in Figure~\ref{subfig:s4_HR} with inverse transforms. The two }
