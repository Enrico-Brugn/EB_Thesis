...
\begin{sidewaysfigure}
    ...
    \begin{tikzpicture}
        \node[inner sep=0pt] (image) at (0,0) {\includegraphics[width = 0.48\textwidth]{4_Crystalline_properties/Fig/SEM_array.pdf}};
    ...
    \includegraphics[width = 0.48\textwidth]{4_Crystalline_properties/Fig/s5_OV.pdf}
    }
...
\begin{figure}
    ...
    \addplot [cb1_orange,] table[x=nm,y=Ga] {4_Crystalline_properties/csv/s5_III_0deg_linesc.csv};
    \addplot [cb1_dark_blue,] table[x=nm,y=In] {4_Crystalline_properties/csv/s5_III_0deg_linesc.csv};
    \addlegendentry{Ga}
    \addlegendentry{In}
    \end{axis}
    ...
    \addplot [cb1_orange,] table[x=nm,y=As] {4_Crystalline_properties/csv/s5_V_0deg_linesc.csv};
    \addplot [cb1_dark_blue,] table[x=nm,y=P] {4_Crystalline_properties/csv/s5_V_0deg_linesc.csv};
    \addlegendentry{As}
    \addlegendentry{P}
    \end{axis}
...
\begin{figure}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot [cb1_dark_blue,] table[x=wavelength,y=intensity] {4_Crystalline_properties/csv/s4_pl.csv};
            \addplot [cb1_orange,] table[x=wavelength,y=intensity] {4_Crystalline_properties/csv/s5_pl.csv};
            \addlegendentry{Sample 4}
...
\paragraph{Photoluminescence analysis}
\par
