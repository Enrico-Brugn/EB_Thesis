...
\begin{figure}
    ...
    \subcaptionbox{
        ...
        \includegraphics[width=0.31\textwidth]{1_Introduction/Fig/GaAs_100.pdf}
    }
    \subcaptionbox{
        Caption
        \label{subfig:GaAs_110}
    }{
        \includegraphics[width=0.31\textwidth]{1_Introduction/Fig/GaAs_110.pdf}
    }
    \subcaptionbox{
        Caption
        \label{subfig:GaAs_111}
    }{
        \includegraphics[width=0.31\textwidth]{1_Introduction/Fig/GaAs_111.pdf}
    }
