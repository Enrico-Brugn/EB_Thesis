...
\begin{figure}
    ...
    \subcaptionbox{
        ...
        \includegraphics[width=0.31\textwidth]{2_Literature_Review/Fig/GaAs_100.pdf}
    }
    \subcaptionbox{
        \hkl{1 1 0} facet.
        \label{subfig:GaAs_110}
    }{
        \includegraphics[width=0.31\textwidth]{2_Literature_Review/Fig/GaAs_110.pdf}
    }
    \subcaptionbox{
        \hkl{1 1 1}\(_B\) facet.
        \label{subfig:GaAs_111}
    }{
        \includegraphics[width=0.31\textwidth]{2_Literature_Review/Fig/GaAs_111.pdf}
    }
