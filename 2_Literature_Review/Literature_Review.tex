...
\begin{sidewaystable}
    ...
    % \begin{itemize}
    %     \item Allows position control for the III-V growth\cite{Han2016}
    ...
    \begin{itemize}
        ...
        \item Some height limitations in terms of core shell structures, which can’t be grown in nanowires, and are de-facto limited to microdisk form factors \cite{Tiwari2020}
    \end{itemize} \\ \hline
    \caption{Caption}
    \label{tab:methods2}
\end{longtable}
