...
COMBINING III-V AS ACTIVE ELEMENT AND SI AS SUPPORT TO COMBINE HIGH EFFICIENCY WITH CHEAP AND ABBUNDANT SUBSTRATE WITH GOOD OPTICAL PROPERTIES BUT MUST SOLVE LATTICE MISMATCH AS CHIEF CAUSE FOR DEFECTS
...
BAND GAP ENGINEERING WITH TERNARY AND QUATERNARY COMPOUNDS
