...
If the reader asked a common person in the street what "electronics" means they'll receive a variety of responses centered on computers, smartphones, television sets, and other everyday appliances. On the other hand, if the same interviewee demographic was asked about "photonics", some might mention \acl{led}s (\acs{led}s) and lasers, others might cite Star Trek or other science-fiction work. The term photonics has not found widespread understanding outside the semiconductor industry, despite these two technologies often being separated by around a decade in the research and development stages. 

The basic building block of modern electronics, the transistor, was invented in 1948 \cite{Bardeen1948, Bardeen1950}. Pointing to a direct equivalent in the history of photonics is not straightforward; however, the first solid-state light-emitting devices were described just \num{14} years later in 1962 \cite{Biard1966} and consisted of a \acs{gaas} \acs{led} emitting in the infrared. Interest in solid-state lasing sprung up immediately after this discovery \cite{Hall1962, Hall1963} cementing III-V semiconductors in the role of solid-state light emitters. The next year, in 1963, Wanlass invented the \acf{cmos} transistor \cite{Wanlass1967} opening the door for integrated electronics, but this time it took only four years for the idea of a \acf{pic} to follow \cite{Miller1969}.
